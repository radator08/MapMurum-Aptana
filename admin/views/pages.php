	...
	<div class="col-md-9">
		...
		<form action="index.php?page=pages&id=<?php echo $opened['id']; ?>" method="post" role="form">
			...
			<div class="form-group">
				...
				<input class="form-control" type="text" name="slug" id="slug" value="<?php echo $opened['slug'] ;?>" placeholder="Page Label" />
			...
			<div class="form-group">
				...
				<textarea class="form-control editor" name="body" id="body" rows="8" placeholder="Page Title"><?php echo $opened['body'] ;?> </textarea>
